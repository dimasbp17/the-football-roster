    ...
    <>
      <div className="h-full p-2 bg-navy">
        <Card className="flex flex-col p-5 mb-5 bg-yellow-500 text-navy lg:items-center lg:justify-between lg:flex-row">
          <h1 className="mb-2 text-3xl font-bold lg:mb-0">All Leagues</h1>
          ...
          <>
            {filteredLeagues.length > 0 ? (
              <div className="container mx-auto">
                <div className="grid w-full grid-cols-1 gap-4 p-3 md:grid-cols-2">
                  {filteredLeagues.slice(0, visibleLeagues).map((league) => (
                    <div key={league.idLeague}>
                      <Link href={`/clubs/${league.strLeague}`}>
                        <Button className="flex flex-row items-center w-full gap-3 p-3 bg-white border text-navy">
                          <div>
                            <Image
